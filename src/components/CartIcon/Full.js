  ...
  render() {
    ...
    return (
      <svg className={classNames(className)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 484.955 484.955">
        ...
        <path d="M181.605 247.255h195.8c6.6 0 12-5.4 12-12v-173.4c0-6.6-5.4-12-12-12h-195.8c-6.6 0-12 5.4-12 12v173.3c0 6.7 5.3 12.1 12 12.1zm12-158.7l152.1 134.7h-152.1v-134.7zm171.7 120l-152.1-134.7h152.1v134.7z"/>
      </svg>
    )
  }
}
